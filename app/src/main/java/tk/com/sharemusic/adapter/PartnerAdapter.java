...
public class PartnerAdapter extends BaseQuickAdapter<PeopleEntity, BaseViewHolder> {
    public PartnerAdapter(int layoutResId, @Nullable List<PeopleEntity> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder, PeopleEntity peopleEntity) {
